...
class WeatherService {
  ...
  Future<List<Weather>?> getWeather(int locationId) async {
    ...
    final weatherJson = bodyJson['consolidated_weather'] as List; // берем общую погоду в качестве листа

    return [
      for(final weather in weatherJson)
        Weather.fromJson(weather as Map<String, dynamic>), // переводим данные в модел классы
    ];
  }
